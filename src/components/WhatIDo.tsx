        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Designing mobile app UI screens, creating user flows, wireframes, and interactive prototypes.
              </p>
              ...
              <div className="what-content-flex">
                ...
                <div className="what-tags">Prototyping & Wireframing</div>
              </div>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Designing brochures, thumbnails, ads, brand-focused marketing creatives, 2D animations, and promotional videos.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
